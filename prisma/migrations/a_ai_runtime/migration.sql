-- AI-01-03 PostgreSQL private runtime storage. Keep the production driver
-- selection explicit; this migration is applied only to PostgreSQL targets.

CREATE TABLE ai_runtime_epochs (
