...
export function StarIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      {props.title ? <title>{props.title}</title> : null}
      <path d="m10 2.5 2.3 4.7 5.2.8-3.8 3.7.9 5.3-4.6-2.5-4.6 2.5.9-5.3-3.8-3.7 5.2-.8z" />
    </svg>
  );
}
...
export function TrashIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      {props.title ? <title>{props.title}</title> : null}
      <path d="M4 6h12M8 6V4h4v2M6 8v8M10 8v8M14 8v8M5 6l1 12h8l1-12" />
    </svg>
  );
}
...
export function ListIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      {props.title ? <title>{props.title}</title> : null}
      <path d="M5 4h11v12H5zM8 7h5M8 10h5M8 13h3" />
    </svg>
  );
}
...
export function LinkIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      {props.title ? <title>{props.title}</title> : null}
      <path d="M8 12 6.5 13.5a3 3 0 0 1-4-4l2-2a3 3 0 0 1 4-.2M12 8l1.5-1.5a3 3 0 0 1 4 4l-2 2a3 3 0 0 1-4 .2M7 13l6-6" />
    </svg>
  );
}
...
export function AttachmentIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      {props.title ? <title>{props.title}</title> : null}
      <path d="m12.5 6.5-5 5a2.5 2.5 0 0 0 3.5 3.5l5.5-5.5a3.5 3.5 0 0 0-5-5L5 11a4.5 4.5 0 0 0 6.4 6.4l4.1-4.1" />
    </svg>
  );
}
